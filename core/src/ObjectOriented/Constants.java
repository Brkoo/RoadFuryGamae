...
public class Constants {
    ...
    public static final float PERIOD = 1f;
    public static final int BARRIER = 40; //40 px from sides to barrier in main background
    public static final int ROAD1 = 80;
    public static final int ROAD2 = 80 + 115 + 5;
    public static final int ROAD3 = 80 + 230 + 15;
    public static final int ROAD4 = 80 + 345 + 15;
    ...
    public static final long CREATE_BULLET_TIME = 400000000;
}
